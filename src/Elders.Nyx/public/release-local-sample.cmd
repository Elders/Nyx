...
%FAKE% %NYX% "target=%TARGET%" appName=Elders.Nyx appType=file appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetPackageName=Nyx nugetkey=21e666f9-e652-4140-8a43-56195219ff67
